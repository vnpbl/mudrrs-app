      ...
      <div className="flex w-full max-w-5xl min-h-[600px] bg-white/80 backdrop-blur-xl border border-white/70 rounded-3xl shadow-2xl overflow-hidden relative z-10">
        <div className="hidden lg:flex w-[45%] bg-[#991b1b] p-14 text-white flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h1 className="text-4xl font-extrabold leading-tight tracking-tight mb-5">Discussion Room <br /> Reservation</h1>
            <p className="text-[0.95rem] leading-relaxed text-red-200">The official, centralized platform for booking and managing study sessions across Mapúa University Libraries.</p>
          </div>
          <div className="text-xs font-medium text-white/40 tracking-wider uppercase relative z-10">Mapúa University Library Service</div>
        </div>
            ...
            <form onSubmit={handleLogin} autoComplete="off" className="space-y-6">
              ...
              <div className="text-center pt-2">
                <p className="text-sm text-gray-500">Don't have an account yet?{' '}
                  <Link to="/signup" className="text-[#991b1b] hover:text-[#7f1d1d] font-bold hover:underline transition-colors">Sign Up</Link>
                </p>
              </div>
            </form>
          </div>
